...
if __name__ == "__main__":
    print(">> welcome to QRcode generator v1.0, developed by: Artin (Ketchup d) <<")
...
label = tk.Label(frame_url, text="Enter the url/data you want to get as an QRcode:",
...
entryname = tk.Entry(frame_name, width=15, font=font_small,
                     bg="#212121", fg="white")
entryname.pack(pady=15)

labeldone = tk.Label(frame_message, text="done, your qrcode has been saved\n as an image in the qrcode folder in current directory.",
